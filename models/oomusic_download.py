...
class MusicDownload(models.Model):
    ...
    expiration_date = fields.Date(
        'Expiration Date', index=True, default=lambda s: s._default_expiration_date(),
...
class MusicDownloadMixin(models.AbstractModel):
    ...
    download_ids = fields.One2many(
        'oomusic.download', 'res_id', string='Download Links',
    ...
    def action_create_download_link(self):
        for obj in self:
            ...
            self.env['oomusic.download'].create({
