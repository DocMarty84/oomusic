...
class MusicSubsonicListing(http.Controller):
    ...
    def getAlbumList(self, **kwargs):
        ...
        list_type_accepted = [
            'random', 'newest', 'frequent', 'recent', 'starred', 'highest', 'alphabeticalByName',
    ...
    @http.route(['/rest/getRandomSongs.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/getSongsByGenre.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/getNowPlaying.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/getStarred.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/getStarred2.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
