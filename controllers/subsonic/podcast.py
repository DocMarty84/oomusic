...
class MusicSubsonicPodcast(http.Controller):
    @http.route(['/rest/getPodcasts.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/getNewestPodcasts.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route([
        '/rest/refreshPodcasts.view', '/rest/createPodcastChannel.view',
        '/rest/deletePodcastChannel.view', '/rest/deletePodcastEpisode.view',
