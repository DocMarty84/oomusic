...
class MusicSubsonicShare(http.Controller):
    @http.route(['/rest/getShares.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/createShare.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/updateShare.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/deleteShare.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
