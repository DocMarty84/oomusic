...
class MusicSubsonicMediaLibraryScanning(http.Controller):
    @http.route(['/rest/getScanStatus.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/startScan.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
