...
class MusicSubsonicMediaAnnotation(http.Controller):
    @http.route(['/rest/star.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/unstar.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    ...
    @http.route(['/rest/setRating.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
    def setRating(self, **kwargs):
        ...
        if Id:
            ...
            return rest.make_error(
                code='10', message='Required int parameter "id" is not present'
            )
    ...
    @http.route(['/rest/scrobble.view'], type='http', auth='public', csrf=False, methods=['GET', 'POST'])
